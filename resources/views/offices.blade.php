            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div class="office-content">
                    ...
                    <p class="office-description">
                        ...
                        @else
                            Our {{ $office->city }} office provides comprehensive accounting and financial advisory services to businesses and individuals in the {{ $office->state }} region, ensuring local expertise with global standards.
                        @endif
                    </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center fade-in">
                ...
                @if($hasAppointmentLinks)
                    <!-- If any office has appointment link, show dropdown -->
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            @foreach($offices->whereNotNull('appointment_link') as $office)
                            <li><a class="dropdown-item" href="{{ $office->appointment_link }}" target="_blank">{{ $office->name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                @else

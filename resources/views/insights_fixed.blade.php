                ...
                @else
                    ...
                    <article
                        ...
                        <div
                            class="absolute inset-0 flex flex-col justify-center items-center p-6 text-center opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out transform translate-y-4 group-hover:translate-y-0">
                            <span
                                class="text-sm font-semibold text-white/90 uppercase tracking-wide mb-3">SUSTAINABILITY</span>
                            <h3 class="text-2xl font-bold text-white mb-4 leading-tight">
                                <a href="#" class="hover:text-fresh-teal transition-colors duration-300">
                                    ESG Reporting: A Growing Imperative for Businesses
                                </a>
                            ...
                            <p class="text-white/90 text-base leading-relaxed">
                                Understanding Environmental, Social, and Governance reporting requirements and best practices
                    ...
                    <article
                        ...
                        <div
                            ...
                            <p class="text-white/90 text-base leading-relaxed">
                                How advanced analytics and business intelligence tools are transforming financial
                    ...
                    <article
                        class="blog-card fade-in fade-in-delay-2 group cursor-pointer overflow-hidden rounded-lg bg-white shadow-md hover:shadow-2xl transform transition-all duration-500 ease-out hover:scale-[1.02] relative h-80">
                        <!-- Background Image -->
                        <div class="absolute inset-0 w-full h-full">
                        ...
                        <div
                            ...
                            <p class="text-white/90 text-base leading-relaxed">
                                Best practices for implementing effective governance structures in family-owned enterprises to
                    ...
                    <article
                        ...
                        <div
                            ...
                            <p class="text-white/90 text-base leading-relaxed">
                                Essential cybersecurity measures to protect sensitive financial information and maintain data
                                integrity.
                            </p>
                        </div>
                    </article>
                    ...
                    <article
                        ...
                        <div
                            class="absolute inset-0 flex flex-col justify-center items-center p-6 text-center opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out transform translate-y-4 group-hover:translate-y-0">
                            <span class="text-sm font-semibold text-white/90 uppercase tracking-wide mb-3">ECONOMIC
                                OUTLOOK</span>
                            <h3 class="text-2xl font-bold text-white mb-4 leading-tight">
                                <a href="#" class="hover:text-fresh-teal transition-colors duration-300">
                                    Nepal's Economic Outlook: Opportunities and Challenges
                            ...
                            <p class="text-white/90 text-base leading-relaxed">
                                An analysis of Nepal's current economic landscape and strategic insights for businesses
                    ...
                    <article
                        ...
                        <div
                            class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent group-hover:opacity-0 transition-opacity duration-500">
                            <span class="text-xs font-semibold text-white/80 uppercase tracking-wide">COMPLIANCE</span>
                            <h3 class="text-xl font-semibold text-white mt-1">
                                Modern Financial Reporting Standards and Compliance
                            </h3>
                        </div>
                        ...
                        <div
                            class="absolute inset-0 flex flex-col justify-center items-center p-6 text-center opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out transform translate-y-4 group-hover:translate-y-0">
                            <span class="text-sm font-semibold text-white/90 uppercase tracking-wide mb-3">COMPLIANCE</span>
                            <h3 class="text-2xl font-bold text-white mb-4 leading-tight">
                                <a href="#" class="hover:text-fresh-teal transition-colors duration-300">
                                    Modern Financial Reporting Standards and Compliance
                                </a>
                            ...
                            <p class="text-white/90 text-base leading-relaxed">
                                Navigating the evolving landscape of financial reporting standards and ensuring regulatory
                                compliance.
                            </p>
                        </div>
                    </article>

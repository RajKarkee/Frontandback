        ...
        <main>
            ...
            <section class="hero-section">
                <div class="hero-content gsap-animate">
                    <h1>Get in Touch</h1>
                    <p>Connect with our team of experts and discover how we can help transform your business.</p>
                    <div class="d-flex flex-wrap justify-content-center gap-3">
                        <a href="#contact" class="btn-primary-filled"><i class="fas fa-envelope"></i> Contact Us</a>
                        <a href="#services" class="btn-primary-outline"><i class="fas fa-briefcase"></i> Our Services</a>
                    </div>
                </div>
            </section>
            ...
            <section class="location-section">
                <div class="section-container">
                    ...
                    <p class="lead gsap-animate">Visit our main office in Biratnagar or reach out to us for appointments at your convenience.</p>
                    <div class="map-container gsap-animate">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3566.973465836073!2d87.27979731506276!3d26.45213998332637!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ef744e6d0b3e2b%3A0x5f3b9c4e4e4e4e4e!2sBiratnagar%2C%20Nepal!5e0!3m2!1sen!2snp!4v1698765432100!5m2!1sen!2snp" allowfullscreen loading="lazy" aria-label="Chartered Insights Main Office, Biratnagar, Nepal"></iframe>
                    </div>
                    <a href="https://www.google.com/maps/place/Biratnagar,+Nepal" target="_blank" class="btn-primary-filled gsap-animate">View on Google Maps</a>
                </div>
            </section>

                    ...
                    <div class="event-grid">
                        <div class="event-card gsap-animate" data-category="Conference"
                            ...
                            <img src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=1200&auto=format&fit=crop"
                                class="event-image" alt="Conference event">
                            ...
                            <div class="content">
                                ...
                                <p>Join Nepal's premier gathering of accounting and finance professionals for a full day of
                                    insights, networking, and knowledge sharing.</p>
                            </div>
                        </div>
                        <div class="event-card gsap-animate" data-category="Webinar" data-delay="0.2"
                            ...
                            data-details="Online (Zoom)|2:00 PM - 3:30 PM|Free" data-button-text="Join Webinar (Free)"
                            data-button-link="#webinar">
                            <img src="https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?q=80&w=1200&auto=format&fit=crop"
                                class="event-image" alt="Webinar event">
                            <div class="date-container">
                        ...
                        <div class="event-card gsap-animate" data-category="Workshop" data-delay="0.4"
                            ...
                            data-details="CI Training Center|10:00 AM - 4:00 PM|NPR 1500.00" data-button-text="Register Now"
                            data-button-link="#register">
                            <img src="https://images.unsplash.com/photo-1516321310769-65e85b8e6351?q=80&w=1200&auto=format&fit=crop"
                                class="event-image" alt="Workshop event">
                            <div class="date-container">
                            ...
                            <div class="content">
                                ...
                                <p>Interactive workshop covering budgeting, forecasting, and financial strategy for SMEs.
                                </p>
                            </div>
                        </div>
                        <div class="event-card gsap-animate" data-category="Training"
                            ...
                            data-details="CI Training Center|10:00 AM - 4:00 PM|NPR 3000.00" data-button-text="Register Now"
                            data-button-link="#register">
                            <img src="https://images.unsplash.com/photo-1516321497487-e288fb19713f?q=80&w=1200&auto=format&fit=crop"
                                class="event-image" alt="Training event">
                            <div class="date-container">
                                <div class="day">7</div>
                                <div class="month">Sep</div>
                            </div>
                        ...
                        <div class="event-card gsap-animate" data-category="Webinar" data-delay="0.2"
                            ...
                            data-details="Online (Teams)|3:00 PM - 4:30 PM|Free" data-button-text="Join Webinar (Free)"
                            data-button-link="#webinar">
                            <img src="https://images.unsplash.com/photo-1594125730766-91d63d7e7a7b?q=80&w=1200&auto=format&fit=crop"
                                class="event-image" alt="Webinar event">
                            <div class="date-container">
                            ...
                            <div class="content">
                                ...
                                <p>Learn how to identify, assess, and mitigate business risks in today's volatile
                                    environment.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="section-container">
                    ...
                    <div class="event-grid">
                        <div class="event-card gsap-animate" data-category="Webinar"
                            ...
                            data-details="July 26, 2025" data-button-text="View Recording|Download Resources"
                            data-button-link="#recording|#resources">
                            <img src="https://images.unsplash.com/photo-1516321310769-65e85b8e6351?q=80&w=1200&auto=format&fit=crop"
                                class="event-image" alt="Webinar event">
                            <div class="date-container">
                            ...
                            <div class="content">
                                ...
                                <p>Explored automation tools, cloud accounting, and AI applications in modern accounting.
                                </p>
                            </div>
                        </div>
                        <div class="event-card gsap-animate" data-category="Workshop" data-delay="0.2"
                            ...
                            data-details="July 19, 2025" data-button-text="View Recording|Download Resources"
                            data-button-link="#recording|#resources">
                            <img src="https://images.unsplash.com/photo-1542744173-05336fcc7ad4?q=80&w=1200&auto=format&fit=crop"
                                class="event-image" alt="Workshop event">
                            <div class="date-container">
                        ...
                        <div class="event-card gsap-animate" data-category="Webinar" data-delay="0.4"
                            ...
                            data-details="July 11, 2025" data-button-text="View Recording|Download Resources"
                            data-button-link="#recording|#resources">
            ...
            <section class="custom-training-section">
                <div class="section-container">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="#contact" class="btn-custom">Discuss Custom Training <i
                                class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </section>

...
@section('title', 'Create Service Process Step')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Create New Service Process Step</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.service-processes.store') }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('step_number') is-invalid @enderror"
                                       id="step_number" name="step_number" value="{{ old('step_number') }}" min="1" required>
                                @error('step_number')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror"
                                       id="color" name="color" value="{{ old('color', '#20B2AA') }}">
                                @error('color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>Create Step
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="card-body text-center">
                <div class="preview-step">
                    <div class="rounded-circle d-flex align-items-center justify-content-center text-white mx-auto mb-3"
                         style="width: 60px; height: 60px; background-color: #20B2AA;" id="preview-circle">
                        <span class="h5 mb-0" id="preview-number">1</span>
                    </div>
                    <h6 id="preview-title">Step Title</h6>
                    <p class="text-muted small" id="preview-description">Step description will appear here.</p>
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        previewNumber.textContent = stepNumberInput.value || '1';
        previewTitle.textContent = titleInput.value || 'Step Title';
        previewDescription.textContent = descriptionInput.value || 'Step description will appear here.';

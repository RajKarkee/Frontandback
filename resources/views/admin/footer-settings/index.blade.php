                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p><strong>Company Tagline:</strong> {{ $footerSetting->company_tagline ?? 'Not set' }}
                                    </p>
                                    <p><strong>Company Slogan:</strong> {{ $footerSetting->company_slogan ?? 'Not set' }}
                                    </p>
                        ...
                        <div class="text-end">
                            <small class="text-muted">
                                Last updated:
                                {{ $footerSetting->updated_at ? $footerSetting->updated_at->format('M j, Y g:i A') : 'Never' }}
                            </small>
                        </div>
                    </div>
                </div>

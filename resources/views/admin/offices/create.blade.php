                ...
                <div class="card-body">
                    <form action="{{ route('admin.offices.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="name" class="form-label">Office Name <span
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('country') is-invalid @enderror"
                                        id="country" name="country" value="{{ old('country', 'Nepal') }}" required>
                                    @error('country')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('office_hours') is-invalid @enderror" id="office_hours" name="office_hours"
                                        rows="2" placeholder="e.g., Sunday - Friday: 9:00 AM - 6:00 PM">{{ old('office_hours') }}</textarea>
                                    @error('office_hours')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('transportation') is-invalid @enderror" id="transportation"
                                        name="transportation" rows="3" placeholder="Public transport options, bus routes, etc.">{{ old('transportation') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('directions') is-invalid @enderror" id="directions" name="directions"
                                        rows="3" placeholder="Step-by-step directions to the office">{{ old('directions') }}</textarea>
                                    @error('directions')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('parking_info') is-invalid @enderror" id="parking_info" name="parking_info"
                                        rows="2" placeholder="Parking availability, cost, etc.">{{ old('parking_info') }}</textarea>
                                    @error('parking_info')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="url"
                                        class="form-control @error('appointment_link') is-invalid @enderror"
                                        id="appointment_link" name="appointment_link"
                                        value="{{ old('appointment_link') }}" placeholder="https://...">

                ...
                <div class="card-body">
                                        ...
                                        <td>
                                            @if ($insight->featured_image)
                                                <img src="{{ Storage::url($insight->featured_image) }}"
                                                    alt="{{ $insight->title }}" class="img-thumbnail"
                    ...
                    <td>
                        <div class="btn-group" role="group">
                            <a href="{{ route('admin.insights.show', $insight) }}" class="btn btn-sm btn-outline-info"
                                title="View">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.insights.edit', $insight) }}" class="btn btn-sm btn-outline-primary"
                                title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.insights.destroy', $insight) }}" method="POST" class="d-inline"

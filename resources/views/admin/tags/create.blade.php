...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 text-gray-800">Create New Tag</h1>
        <p class="text-muted">Add a new blog tag</p>
    </div>
                    ...
                    <div class="alert alert-light border">
                        ...
                        <div class="mt-1">
                            <small class="text-muted" id="descriptionPreview">
                                {{ old('description', 'Description will appear here...') }}
                            </small>
                        </div>
                    </div>
...
document.getElementById('name').addEventListener('input', function() {
    ...
    document.getElementById('slugPreview').textContent = 'Slug: ' + (slug || 'tag-slug');
});

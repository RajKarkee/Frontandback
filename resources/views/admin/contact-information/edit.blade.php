        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('admin.contact-information.show', $contactInformation) }}" class="btn btn-outline-info">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.contact-information.update', $contactInformation) }}">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('additional_info') is-invalid @enderror"
                                                      ...
                                                      rows="3">{{ old('additional_info', $contactInformation->additional_info) }}</textarea>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input"
                                                   ...
                                                   name="is_active"
                                                   value="1"
                                                   {{ old('is_active', $contactInformation->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" id="latitude" name="latitude" value="{{ old('latitude', $contactInformation->latitude) }}">
                                        <input type="hidden" id="longitude" name="longitude" value="{{ old('longitude', $contactInformation->longitude) }}">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        @php
                                            $socialMedia = $contactInformation->social_media_links ?? [];
                                        @endphp
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="url"
                                                   ...
                                                   value="{{ old('social_media.facebook', $socialMedia['facebook'] ?? '') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="url"
                                                   ...
                                                   value="{{ old('social_media.twitter', $socialMedia['twitter'] ?? '') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="url"
                                                   ...
                                                   value="{{ old('social_media.linkedin', $socialMedia['linkedin'] ?? '') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="url"
                                                   ...
                                                   value="{{ old('social_media.instagram', $socialMedia['instagram'] ?? '') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="url"
                                                   ...
                                                   value="{{ old('social_media.youtube', $socialMedia['youtube'] ?? '') }}"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        @php
                                            $businessHours = $contactInformation->business_hours ?? [];
                                        @endphp
                                        <div class="row">
                                            @foreach(['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
                                                <div class="col-md-6 col-lg-3 mb-3">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           value="{{ old('business_hours.'.$day, $businessHours[$day] ?? '') }}"
...
function initMap() {
    // Get existing coordinates or use default center (Biratnagar, Nepal)
    const existingLat = document.getElementById('latitude').value;
    const existingLng = document.getElementById('longitude').value;

    const defaultCenter = {
        lat: existingLat ? parseFloat(existingLat) : 26.4525,
        lng: existingLng ? parseFloat(existingLng) : 87.2718
    };
    ...
    // If we have existing coordinates, update the map data
    if (existingLat && existingLng) {
        updateLocationData(parseFloat(existingLat), parseFloat(existingLng));
    }
}

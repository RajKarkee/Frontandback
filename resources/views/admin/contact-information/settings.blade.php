                        ...
                        <form action="{{ route('admin.contact-information.settings.save') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('additional_info') is-invalid @enderror" id="additional_info"
                                                    name="additional_info" rows="2" placeholder="Any additional contact details...">{{ old('additional_info', $contactInformation->additional_info ?? '') }}</textarea>
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="is_active">
                                                    ...
                                                    <small class="text-muted d-block">Make this contact information visible
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-header">
                                            <h5 class="mb-0"><i class="fas fa-share-alt me-2"></i>Social Media Links
                                            </h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            @php
                                                ...
                                                $businessHours = old(
                                                    'business_hours',
                                                    optional($contactInformation)->business_hours ?? [],
                                                );
                                            @endphp
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div
                                                    style="height: 300px; border: 1px solid #ddd; border-radius: 4px; overflow: hidden;">
                                                    <iframe id="gmap_canvas" src="" width="100%"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <small class="text-muted">
                                                    ...
                                                    {{ $contactInformation->created_at->format('M d, Y \a\t g:i A') }}<br>
                                                    <strong>Last Updated:</strong>
                                                    {{ $contactInformation->updated_at->format('M d, Y \a\t g:i A') }}<br>

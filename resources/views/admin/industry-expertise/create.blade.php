...
@section('title', 'Create Industry Expertise')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 text-gray-800">Create New Industry Expertise</h1>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.industry-expertise.store') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('svg_icon') is-invalid @enderror"
                                                      ...
                                                      placeholder="<svg>...</svg>">{{ old('svg_icon') }}</textarea>
                                            @error('svg_icon')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="color" class="form-control form-control-color @error('color_theme') is-invalid @enderror"
                                                   id="color_theme" name="color_theme" value="{{ old('color_theme', '#007bff') }}">
                                            @error('color_theme')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> Create Expertise
                                    </button>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div id="preview-card" class="text-center p-3 border rounded">
                                <div id="preview-icon" class="mb-3" style="color: #007bff;">
                                    <i class="fas fa-eye fa-2x"></i>
                                </div>
                                <h5 id="preview-title">Expertise Title</h5>
                                <p id="preview-description" class="text-muted">Expertise description will appear here...</p>
                            </div>
                        </div>
                    </div>
                </div>

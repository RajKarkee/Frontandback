            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.industry-expertise.update', $industryExpertise) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                                   id="title" name="title" value="{{ old('title', $industryExpertise->title) }}" required>
                                            @error('title')
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('sort_order') is-invalid @enderror"
                                                   id="sort_order" name="sort_order" value="{{ old('sort_order', $industryExpertise->sort_order) }}" min="1">
                                            @error('sort_order')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              id="description" name="description" rows="4" required>{{ old('description', $industryExpertise->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('svg_icon') is-invalid @enderror"
                                                      ...
                                                      placeholder="<svg>...</svg>">{{ old('svg_icon', $industryExpertise->svg_icon) }}</textarea>
                                            @error('svg_icon')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('icon_class') is-invalid @enderror"
                                                   id="icon_class" name="icon_class" value="{{ old('icon_class', $industryExpertise->icon_class) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="color" class="form-control form-control-color @error('color_theme') is-invalid @enderror"
                                                   id="color_theme" name="color_theme" value="{{ old('color_theme', $industryExpertise->color_theme ?? '#007bff') }}">
                                            @error('color_theme')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                                                <option value="active" {{ old('status', $industryExpertise->status) === 'active' ? 'selected' : '' }}>Active</option>
                                                <option value="inactive" {{ old('status', $industryExpertise->status) === 'inactive' ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                            @error('status')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check mt-4">
                                                <input class="form-check-input @error('is_featured') is-invalid @enderror"
                                                       ...
                                                       {{ old('is_featured', $industryExpertise->is_featured) ? 'checked' : '' }}>
                ...
                <div class="col-lg-4">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div id="preview-card" class="text-center p-3 border rounded" style="border-color: {{ $industryExpertise->color_theme ?? '#007bff' }};">
                                <div id="preview-icon" class="mb-3" style="color: {{ $industryExpertise->color_theme ?? '#007bff' }};">
                                    @if($industryExpertise->svg_icon)
                                        {!! $industryExpertise->svg_icon !!}
                                    @elseif($industryExpertise->icon_class)
                                        <i class="{{ $industryExpertise->icon_class }} fa-2x"></i>
                                    @else
                                        <i class="fas fa-eye fa-2x"></i>
                                    @endif
                                </div>
                                <h5 id="preview-title">{{ $industryExpertise->title }}</h5>
                                <p id="preview-description" class="text-muted">{{ $industryExpertise->description }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow mt-3">
                        ...
                        <div class="card-body">
                            <small class="text-muted">
                                <strong>Created:</strong> {{ $industryExpertise->created_at->format('M d, Y H:i') }}<br>
                                <strong>Updated:</strong> {{ $industryExpertise->updated_at->format('M d, Y H:i') }}<br>
                                <strong>ID:</strong> {{ $industryExpertise->id }}
                            </small>
                        </div>
                    </div>
                </div>
